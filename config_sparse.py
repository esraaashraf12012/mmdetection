...
_base_ = 'configs/sparse_rcnn/sparse-rcnn_r50_fpn_1x_coco.py'          #base config ResNet50 backbone
#_base_ = 'configs/sparse_rcnn/sparse-rcnn_r101_fpn_300-proposals_crop-ms-480-800-3x_coco.py' #base config ResNet101 backbone
...
# hyper-parametets optimization(learning rate,optmizer,etc)
optim_wrapper = dict(
    optimizer=dict(
